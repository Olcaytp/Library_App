...
namespace Library_App {
    ...
    public partial class LibraryDataSet1 : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public BooksRow AddBooksRow(string BookName, string Author, string Type, string Page, bool Status) {
...
namespace Library_App.LibraryDataSet1TableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Books` WHERE ((`Bookid` = ?) AND ((? = 1 AND `BookName` IS NULL) OR (`BookName` = ?)) AND ((? = 1 AND `Author` IS NULL) OR (`Author` = ?)) AND ((? = 1 AND `Type` IS NULL) OR (`Type` = ?)) AND ((? = 1 AND `Page` IS NULL) OR (`Page` = ?)) AND ((? = 1 AND `Status` IS NULL) OR (`Status` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Books` (`BookName`, `Author`, `Type`, `Page`, `Status`) VALUES (?, ?" +
                ", ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Books` SET `BookName` = ?, `Author` = ?, `Type` = ?, `Page` = ?, `Status` = ? WHERE ((`Bookid` = ?) AND ((? = 1 AND `BookName` IS NULL) OR (`BookName` = ?)) AND ((? = 1 AND `Author` IS NULL) OR (`Author` = ?)) AND ((? = 1 AND `Type` IS NULL) OR (`Type` = ?)) AND ((? = 1 AND `Page` IS NULL) OR (`Page` = ?)) AND ((? = 1 AND `Status` IS NULL) OR (`Status` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Library_App.Properties.Settings.Default.LibraryConnectionString1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Bookid, BookName, Author, Type, Page, Status FROM Books";
        ...
        public virtual int Delete(int Original_Bookid, string Original_BookName, string Original_Author, string Original_Type, string Original_Page, bool Original_Status) {
            ...
            if ((Original_Page == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((string)(Original_Page));
            }
        ...
        public virtual int Insert(string BookName, string Author, string Type, string Page, bool Status) {
            if ((BookName == null)) {
            ...
            if ((Page == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(Page));
            }
        ...
        public virtual int Update(string BookName, string Author, string Type, string Page, bool Status, int Original_Bookid, string Original_BookName, string Original_Author, string Original_Type, string Original_Page, bool Original_Status) {
            if ((BookName == null)) {
            ...
            if ((Page == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Page));
            }
            ...
            if ((Original_Page == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((string)(Original_Page));
            }
